...
**Note** if widgets are created for distribution, `widgetloader.php` must be included in the distributed package, then load it via the plugin's pilot file. ![See The Plugin Development Guide](https://github.com/WebsiteDons/elementor-widget-creator-library#creating-a-distributable-plugin)
